...
#' @export
emMixRHLP <- function(X, Y, G, K, p = 3, q = 1, variance_type = c("heteroskedastic", "homoskedastic"), n_tries = 1, max_iter = 1000, threshold = 1e-5, init_kmeans = TRUE, verbose = TRUE, verbose_IRLS = FALSE) {
